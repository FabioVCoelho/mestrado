	...
	.data
	vetor: .word 3, 3, 1, 3, 3, 1, 4, 3, 1 # save[0] até save[8]
	
	.text
	main:
	    la   s6, vetor      # endereço base de save[]
	    addi s5, zero, 7    # indices = numero de valores no vetor
	    lw   s0, 0(s6)      # maior_valor = primeiro valor é o maior no momento, salvo em s0
	    addi s3, zero, 0    # i = inicializa contador do loop
